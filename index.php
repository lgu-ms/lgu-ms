                    ...
                    <div class="position-relative" style="display: flex;flex-wrap: wrap;justify-content: flex-end;">
                        <div style="position: relative;flex: 0 0 45%;transform: translate3d(-15%, 35%, 0);">
                            <img class="img-fluid shadow" data-bss-parallax="" data-bss-parallax-speed="0.8"
                                src="images/program1.jpg" title="QC ID">
                        </div>
                        <div style="position: relative;flex: 0 0 45%;transform: translate3d(-5%, 20%, 0);">
                            <img class="img-fluid shadow" data-bss-parallax="" data-bss-parallax-speed="0.4"
                                src="images/program2.jpg" title="Covid Response">
                        </div>
            ...
            <div class="card-group">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">MAHALAGANG ANUNSYO MULA SA CITY TREASURER’S OFFICE QCitizens, magbayad nang
                            maaga para
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">MAHALAGANG ABISO SA MGA MOTORISTA Asahan ang pagbagal ng daloy ng trapiko
                            sa paligid ng
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Narito ang schedule ng operasyon ng Q City Bus mula October 28, 2023
                            (Saturday)
        ...
        <div class="container pt-4 pt-xl-5">
            <div class="card mb-3">
                <div class="row g-0">
                    ...
                    <div class="col-md-6 p-1">
                        ...
                        “Ang lahat ng ating nagawa at gagawin pa sa mga susunod na taon ay bunga ng hindi nagbabagong
                        pangako natin
                        sa isa’t isa – na lagi tayong magtutulungan para sa kabutihan ng lahat. I am proud of our
                        accomplishments as
                        a city, because these are the results of our collective efforts and commitment for positive
                        change.”
                    </div>
                </div>
            </div>
            <div class="card mb-3">
                <div class="row g-0">
                    <div class="col-md-6 p-1">
                        ...
                        Nowadays, it was considered as the center of Quezon City and it serves as the people’s park. Its
                        main
                        feature is a mausoleum containing the remains of Manuel L. Quezon, the second President of the
                        Philippines,
            ...
            <div class="card mb-3 ">
                <div class="row g-0">
                    ...
                    <div class="col-md-6 p-1">
                        <h2>City Hall</h2>
                        The Quezon City Hall is a government building which houses the office of the Mayor of Quezon
                        City located
                        along the Elliptical Road. The Quezon City Council is housed within the adjacent Legislative
                        Wing.
                    </div>
                </div>
            </div>
