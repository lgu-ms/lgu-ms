            ...
            <div class="row align-items-center g-lg-5 py-5">
                ...
                <div class="col-md-10 mx-auto col-lg-5">
                    <form class="p-4 p-md-5 bg-body-auto" id="register" method="post">
                        ...
                        <button class="btn btn-primary shadow px-4 mt-4" type="submit" name="regBtn">Register</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="p-4 p-md-1" id="comment" method="post">
                        ...
                        <button class="btn btn-primary shadow px-4 mt-4" type="submit" name="feedbackBtn" href="#form">Submit Feedback & Rating</button>
                    </form>
                </div>

                <div class="col-md-6">
                    <form class="p-4 p-md-1 " id="service" method="post">
                        ...
                        <button class="btn btn-primary shadow px-4 mt-4" type="submit" name="serviceBtn" href="#form">Submit Services</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <a href="index.php" class="active text-center mt-5">Return to main page.</a>
            </div>
        </div>
    </div>
